...
function rps(shot) {
	...
	if (randInt == 1) {opponentChoice = "rock"} 
    else if (randInt == 2) {opponentChoice = "paper"}
    
	if (shot == undefined) {return { opponentChoice };}
...
function rpsls(shot) {
    ...
    else if (randInt == 3) {opponenetChoice = "spock"}
    else if (randInt == 4) {opponenetChoice = "lizard"}
    
	if (shot == undefined) {return { opponentChoice };} // 404 ! 
